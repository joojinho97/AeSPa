...
![Pytorch 2.5](https://img.shields.io/badge/Pytorch-2.5-orange.svg?style=plastic)

![CUDA 11.8](https://img.shields.io/badge/CUDA-11.8-darkyellow.svg?style=plastic)
![CUDNN 11.7](https://img.shields.io/badge/CUDNN-8.2.1-blue.svg?style=plastic)
### Repository for [AeSPa : Attention-guided Self-supervised Parallel imaging for MRI Reconstruction](https://link.springer.com/chapter/10.1007/978-3-031-43990-2_18) published in [CVPR 2025](https://cvpr.thecvf.com/) 
 #### Jinho Joo<sup>1</sup>\*, Hyeseong Kim<sup>1</sup>\*, Hyeyeon Won<sup>1</sup>, Deukhee Lee<sup>2</sup>, Taejoon Eo<sup>1</sup>\*\*, Dosik Hwang<sup>1</sup>\*\*  
 #### <sup>1</sup>Yonsei University, <sup>2</sup>Ewha Womans University Medical Center  
 #### \* denotes equal contribution, \** denotes corresponding authors  

<p align="center"><img src='img/knee.png' width="85%" height="85%"></p>
<p align="center"><img src='imgs/brain.png' width="85%" height="85%"></p>
